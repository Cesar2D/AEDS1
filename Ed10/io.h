...
/**
    Funcao para reservar espaco para guardar inteiros.
    @return area reservada, se houver; NULL, caso contrario
    @param rowls - quantidade de linhas
    @param colunms - quantidade de colunas
 */
ints* IO_new_matrix ( int rows, int columns)
{   
    // declarar variaveis
    int x = 0;
    int y = 0;
    ...
    // alocacao de ponteiros de ponteiros
    mat = malloc ( (rows)*sizeof(int*) );

    // alocacao de ponteiros por cada posicao de ponteiros de ponteiros
