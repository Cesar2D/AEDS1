...
void decorateWorld(const char *fileName)
{
    ...
    world->set(5, 1, HWALL); // horizontal
            ...
            // Vertical
    world->set(7, 3, VWALL); // vertica
    world->set(7, 2, VWALL); // vertica
    world->set(4, 2, VWALL); // vertica
    world->set(4, 3, VWALL); // vertica
    world->set(4, 4, VWALL); // vertica

    // colocar um marcador no mundo
    world->set(4, 4, BEEPER);
    world->set(7, 5, BEEPER);
...
int main()
{
  ...
  Versao Teste
   ...
   1.0 0.1 ( OK ) teste com outra forma de repeticao
       0.2 ( OK ) teste com outra forma de alternativa
  */