...
void method_12(void)
{
    ...
    // saidas
    printf("\nA area do quadrado (com 1/3 do lado): %lf", area);
    printf("\nO perimetro do quadrado ( com 1/3 do lado): %lf", perimetro);
...
void method_14()
{
    ...
    // saidas
    printf("\nO valor da area com o tamanho 5 vezes menor e: %lf", area);
    printf("\nO valor do perimetro com o tamanho 5 vezes menor e: %lf", perimetro);
