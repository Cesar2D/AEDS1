...
void method_17(void)
{
    ...
    // entradas
    a = IO_readint("Digite o valor minimo: ");
    b = IO_readint("Digite o valor maximo: ");
    n = IO_readint("Digite o numero de testes: ");
    ...
    for (y = 0; y < n; y = y + 1)
    {
        ...
        if (x >= a && x <= b)
        {
            if (x % 5 == 0)
            {
                IO_printf("O valor esta entre %d e %d, e e multiplo de 5", a, b);
                cont = cont + 1;
            }
            else
            {
                IO_printf("O valor esta entre %d e %d mas nao e multiplo de 5", a, b);
            }
        }
        else
        {
            IO_printf("O valor nao esta entre %d e %d", a, b);
        }
    } // end for
    ...
    for (y = 0; y < n; y = y + 1)
    {
        ...
        if (x >= a && x <= b)
        {
            if (x % 3 == 0)
            {
                if (!(x % 5 == 0))
                {
                    IO_printf("O valor esta entre %d e %d e e multiplo de 3 e nao e multiplo de 5", a, b);
                    cont = cont + 1;
                } // end if 3
                else
                {
                    IO_printf("O valor esta entre %d e %d e e multiplo de 3 e e multiplo de 5", a, b);
                } // end else 3
            }     // end if 2
            else
            {
                IO_printf("O valor esta entre %d e %d e nao e multiplo de 3", a, b);
            } // end else 2
        }     // end if
        else
        {
...
void method_19(void)
{
    ...
    n = IO_readint("Digite o valor de vezes: ");
    ...
    for (y = 0; y < n; y = y + 1)
    {
        ...
        if (x > a && x < b)
        {
            if (inte % 2 == 1)
            {
                IO_printf("O valor esta entre %lf e %lf e e impar: %lf", a, b, x);
            }
            else
            {
                IO_printf("O valor esta entre %lf e %lf mas nao e impar: %lf", a, b, x);
            }

        } // end if
        else
        {
            IO_printf("O valor nao esta entre %lf e %lf", a, b);
        }
    } // end for
...
void method_20(void)
{
    ...
    double a = 0.0, // minima
        b = 0.0,    // maxima
        x = 0.0,    // variavel
        frac = 0.0; // parte fracionaria
    int y = 0,      // variavel for
        n = 0,      // n de vezes
        cont = 0,   // contador
        inte = 0;   // parte inteira

    // entradas
    do
    {
        a = IO_readdouble("Digite o valor real minimo: ");
        b = IO_readdouble("Digite o valor real maximo: ");
        n = IO_readint("Digite o numero inteiro de vezes: ");
    ...
    for (y = 0; y < n; y = y + 1)
    {
        ...
        if(!(frac > a && frac < b))
        {
            IO_printf("O valor fracionario de %lf esta fora do periodo", x);
            cont = cont + 1;
        }
        else
        {
            IO_printf("A parte fracionaria esta entre %lf e %lf ", a, b);
        }
    } // end for
...
int main(void)
{
    ...
    {
        // identifcar
        IO_id("EXEMPLO0320 - Programa - v2.0");
