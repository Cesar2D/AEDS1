...
void method_19(void)
{
    ...
    // entrada
    n = IO_readint("Digite o valor de n = ");
    
    // chamada da funcao
    soma = quadNumNat(n);
    
    IO_printf("O valor da soma e: %d", soma);
    // encerrar
    IO_pause("Aperte <Enter> para continuar");
...
void method_20(void)
{
    ...
    // entrada
    n = IO_readint("Digite o numero de vees: ");
    
    // chamada da funcao
    m = fraNat(n);
    
    // saida
    IO_printf("O valor da soma e: %lf", m);
