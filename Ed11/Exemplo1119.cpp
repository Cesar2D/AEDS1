...
void method_14()
{
    ...
    soma = int_array.addInterval(menor, maior);
...
void method_15()
{
    ...
    media = int_array.averageInterval(p1, p2);
    
    cout << "A media da posicao ["<< p1 << "]" <<" e da posicao " << "["<< p2 << "] e " << media << endl;
...
void method_16()
{
    ...
    if(int_array.positives())
    {
        cout << "So existem valores positivos" << endl;
    }
    else
    {
        cout << "Existem um ou mais valores negativos" << endl;
    }
...
void method_17()
{
    ...
    if(int_array.isCrescent())
    {
        cout << "Os valores estao crescentes." << endl;
    }
    else
    {
        cout << "Os valores nao estao crescentes." << endl;
    }
    // encerrar
    pause("Apertar ENTER para continuar");
}
...
void method_18()
{
    ...
    if(int_array.searchInterval( val, inicio, fim ))
    {
        cout << "O valor esta presente entre [" << inicio <<"] e [" << fim << "]" << endl;
    }
    else
    {
        cout << "O valor nao esta presente" << endl;
    }
...
void method_19()
{
    ...
    array2 = int_array.scalar(val, inicio, fim);
...
int main(int argc, char **argv)
{
    ...
    {
        // identificar
        cout << "EXEMPLO1119 - Programa - v1.9\n " << endl;
